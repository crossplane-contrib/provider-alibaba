# Building and Installing the Crossplane Alibaba Cloud Provider

`provider-alibaba` is composed of a golang project and can be built directly with
...
You can build the Crossplane Alibaba Cloud Provider for the host platform by simply
